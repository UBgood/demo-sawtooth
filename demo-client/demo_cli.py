'''     
Command line interface for the demo transaction family.

Parses command line arguments and passes it to the demoClient class
to process.
''' 
...
def do_deposit(args):
    ...
    client = demoWalletClient(baseUrl=DEFAULT_URL, keyFile=keyfile)
...
def do_transfer(args):
    ...
    clientFrom = demoWalletClient(baseUrl=DEFAULT_URL, keyFile=keyfileFrom)
